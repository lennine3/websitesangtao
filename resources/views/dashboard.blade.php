            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-card-two">
                    <div class="widget-content">
                        ...
                        <div class="media">
                            <div class="w-img">
                                <img alt="avatar" src="{{ asset('admin/assets/img/g-8.png') }}" />
                            </div>
                            <div class="media-body">
                        ...
                        <div class="card-bottom-section">
                            ...
                            <div class="img-group">
                                <img alt="avatar" src="{{ asset('admin/assets/img/profile-19.jpeg') }}" />
                                <img alt="avatar" src="{{ asset('admin/assets/img/profile-6.jpeg') }}" />
                                <img alt="avatar" src="{{ asset('admin/assets/img/profile-8.jpeg') }}" />
                                <img alt="avatar" src="{{ asset('admin/assets/img/profile-3.jpeg') }}" />
                            </div>
