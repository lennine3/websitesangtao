            ...
            <li class="nav-item dropdown language-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{ asset('admin/assets/img/1x1/us.svg') }}" class="flag-width" alt="flag"> <span
                            class="align-self-center">&nbsp;English</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{ asset('admin/assets/img/1x1/tr.svg') }}" class="flag-width" alt="flag"> <span
                            class="align-self-center">&nbsp;Turkish</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{ asset('admin/assets/img/1x1/br.svg') }}" class="flag-width" alt="flag"> <span
                            class="align-self-center">&nbsp;Portuguese</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);">
                        <img src="{{ asset('admin/assets/img/1x1/in.svg') }}" class="flag-width" alt="flag">
                        <span class="align-self-center">&nbsp;Hindi</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{ asset('admin/assets/img/1x1/de.svg') }}" class="flag-width" alt="flag"> <span
                    ...
                    <div class="notification-scroll">
                        <div class="dropdown-item">
                            <div class="media server-log">
                                <img src="{{ asset('admin/assets/img/profile-16.jpeg') }}" alt=""
                        ...
                        <div class="dropdown-item">
                            <div class="media ">
                                <img src="{{ asset('admin/assets/img/profile-15.jpeg') }}" alt=""
                                    class="img-fluid me-2" alt="avatar">
                                <div class="media-body">
                                    <div class="data-info">
                        ...
                        <div class="dropdown-item">
                            <div class="media file-upload">
                                <img src="{{ asset('admin/assets/img/profile-21.jpeg') }}" alt=""
                                    class="img-fluid me-2" alt="avatar">
                                <div class="media-body">
                                    <div class="data-info">
                ...
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                    ...
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            <img alt="avatar" src="{{ Auth::user()->avatar != null ? asset(config('user.image.path') .  Auth::user()->id . '/' .  Auth::user()->avatar) : asset('admin/assets/img/blank.png') }}"
