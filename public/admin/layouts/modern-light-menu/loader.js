...
var settingsObject = {
    ...
    settings: {
        layout: {
            ...
            boxed: true,
            logo: {
                darkLogo: '../public/admin/assets/img/logo.svg',
                lightLogo: '../public/admin/assets/img/logo2.svg'
            }
        }
    },
    reset: false
...
if (corkThemeObject.settings.layout.darkMode) {
    ...
    if (getParseObject.settings.layout.darkMode) {
        if (document.body && document.body.getAttribute('page') === 'starter-pack') {
            ifStarterKit = true;
        } else {
            ifStarterKit = false;
        }
        ...
        if (ifStarterKit) {
            if (document.querySelector('.navbar-logo')) {
                document.querySelector('.navbar-logo').setAttribute('src', '../../public/admin/assets/img/logo.svg')
            }
        } else {
            if (document.querySelector('.navbar-logo')) {
    ...
    if (!getParseObject.settings.layout.darkMode) {
        ...
        // if (ifStarterKit) {
        //     if (document.querySelector('.navbar-logo')) {
        //         document.querySelector('.navbar-logo').setAttribute('src', '../../public/admin/assets/img/logo2.svg')
        //     }
        // } else {
        //     if (document.querySelector('.navbar-logo')) {
