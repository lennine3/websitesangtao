    ...
    ((e = (function() {
      ...
      return function(t, s) {
        ...
        (n.defaults = {
          ...
          (1 != n.options.centerMode && 1 != n.options.vertical) ||
            (n.options.slidesPadding = n.options.slidesMargin),
          (1 != n.options.fade &&
            1 != n.options.vertical &&
            1 != n.options.centerMode) ||
            (n.options.slidesMargin = 0),
      ...
      (e.prototype.buildDots = function() {
        ...
        if (!0 === s.options.dots) {
          for (
            ...
            t.append(
              i("<li />").append(s.options.customPaging.call(this, s, e))
            );
      ...
      (e.prototype.getLeft = function(i) {
        ...
        return (
          (n.slideOffset =
            -i * (n.options.slidesMargin / n.options.slidesToShow)),
          (t = n.$slides.first().outerHeight(!0)),
          !0 === n.options.infinite
            ? (n.slideCount > n.options.slidesToShow &&
                ((n.slideOffset =
                  -1 *
                  (n.slideWidth * n.options.slidesToShow +
                    n.options.slidesMargin +
                    i *
                      Math.floor(
                        n.options.slidesMargin / n.options.slidesToShow
                      ))),
                (o = -1),
        ...
        if (
          (!0 === o.options.centerMode
            ...
            : ((t = o.options.infinite
              ...
              !0 === o.options.fade &&
                (t > 0 && t--, s <= o.slideCount && s++)),
          (e = o.$slider.find(".slick-slide").slice(t, s)),
          "anticipated" === o.options.lazyLoad)
        )
          for (
            var r = t - 1, l = s, d = o.$slider.find(".slick-slide"), a = 0;
      ...
      (e.prototype.setCSS = function(i) {
        var e,
          ...
          s = this,
          o = {};
        !0 === s.options.rtl && !0 !== s.options.vertical && (i = -i),
      ...
      (e.prototype.setDimensions = function() {
        ...
        !1 === i.options.vertical
          ...
          !1 === i.options.vertical && !1 === i.options.variableWidth
            ? ((e = i.options.slidesMargin / i.options.slidesToShow),
            ...
            : ((i.slideWidth = Math.abs(i.listWidth)),
              i.$slideTrack.height(
                Math.abs(
        ...
        !1 === i.options.variableWidth &&
          i.$slideTrack.children(".slick-slide").width(i.slideWidth - s + e);
      }),
          ...
          0 == r.options.vertical
            ? 0 == r.options.centerMode
              ...
              : r.$slider
                  ...
                  .children(".slick-track")
                  .children()
                  .css("padding", "0 " + r.options.slidesPadding / 2 + "px")
            : (r.$slider
                .children(".slick-list")
                .css({
                  "margin-top": -r.options.slidesPadding / 2,
                  "margin-bottom": -r.options.slidesPadding / 2,
                }),
              r.$slider
                .children()
                .children(".slick-track")
                .children()
                .css({
                  "padding-top": r.options.slidesPadding / 2,
                  "padding-bottom": r.options.slidesPadding / 2,
                })),
          (t = r.$slider
            .children()
            .children(".slick-track")
